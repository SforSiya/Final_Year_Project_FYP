...
class Story3Page extends StatelessWidget {
  ...
  final List<Map<String, String>> storyData = [
    ...
    {'image': 'assets/tables/table_9_10.png'},
    {'image': 'assets/tables/table_11_12.png'},
  ];
            ...
            return Padding(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: Image.asset(
                    storyItem['image']!,
                    height: 600, // Adjust height for a more rectangular shape
